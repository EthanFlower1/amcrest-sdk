...
func TestStorageGetDiskInfo(t *testing.T) {
	c := testClient(t)
...
func TestStorageGetDeviceNames(t *testing.T) {
	c := testClient(t)
	ctx := context.Background()
...
func TestStorageGetAllDeviceInfo(t *testing.T) {
	c := testClient(t)
	ctx := context.Background()
...
func TestStorageGetCaps(t *testing.T) {
	c := testClient(t)
	ctx := context.Background()
...
func TestStorageGetNASConfig(t *testing.T) {
	c := testClient(t)
	ctx := context.Background()
...
func TestStorageGetStorageGroupConfig(t *testing.T) {
	c := testClient(t)
	ctx := context.Background()
...
func TestStorageGetStorageHealthAlarm(t *testing.T) {
	c := testClient(t)
	ctx := context.Background()
